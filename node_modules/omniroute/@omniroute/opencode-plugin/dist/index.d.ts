...
declare function buildLogger(getLevel: () => LogLevel): {
    ...
    child(tag: string): {
        error: (msg: string, ...args: unknown[]) => false | void;
        warn: (msg: string, ...args: unknown[]) => false | void;
        info: (msg: string, ...args: unknown[]) => false | void;
        debug: (msg: string, ...args: unknown[]) => false | void;
    };
};
type Logger = ReturnType<typeof buildLogger>;
...
declare const optionsSchema: z.ZodObject<{
    ...
    features: z.ZodOptional<z.ZodObject<{
        ...
        visibleModels: z.ZodOptional<z.ZodArray<z.ZodString>>;
        hiddenModels: z.ZodOptional<z.ZodArray<z.ZodString>>;
 ...
 */
type OmniRouteAutoCombosFetcher = (baseURL: string, apiKey: string, timeoutMs?: number, logger?: OmniRouteLoggerSink) => Promise<OmniRouteRawAutoCombo[]>;
/**
 ...
 */
declare function compileModelListFilter(list?: string[]): ModelListFilter | undefined;
/**
 ...
 * verdict logic without divergence.
 */
declare function passesModelAllowlist(id: string, visible?: ModelListFilter, hidden?: ModelListFilter): boolean;
/**
 ...
 */
declare function passesComboAllowlist(combo: OmniRouteRawCombo, visible?: ModelListFilter): boolean;
/**
 ...
 */
declare function buildStaticProviderEntry(rawModels: OmniRouteRawModelEntry[], rawCombos: OmniRouteRawCombo[], opts: ReturnType<typeof resolveOmniRoutePluginOptions>, baseURL: string, apiKey: string, enrichment?: OmniRouteEnrichmentMap, compressionCombos?: OmniRouteCompressionCombo[], connections?: OmniRouteProviderConnection[], rawAutoCombos?: OmniRouteRawAutoCombo[], logger?: OmniRouteLoggerSink): OmniRouteStaticProviderEntry;
/**
...
type OmniRouteDiskSnapshotReader = (providerId: string, identityFingerprint: string) => Promise<(Omit<OmniRouteFetchCacheEntry, "expiresAt"> & {
    writtenAt?: number;
}) | undefined>;
...
declare function _resetInflightRefresh(): void;
/**
