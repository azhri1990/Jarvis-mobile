...
import { HOVER_ONLY_TRIGGER_ATTR } from "./hoverOnlyPress.mjs";
...
const PopoverInGroup = ({ children, ref: refProp, ...props }) => {
	...
	const { openOnClick, openOnHover } = useMemo(() => parseTrigger(item.trigger ?? "hover"), [item.trigger]);
	...
	const triggerProps = {
		[HOVER_ONLY_TRIGGER_ATTR]: openOnClick ? void 0 : "",
