 ...
 */
declare function convertLatexDelimiters(text: string): string;
/**
 ...
 */
declare function escapeMhchemCommands(text: string): string;
/**
 ...
 */
declare function escapeLatexPipes(text: string): string;
/**
 ...
 */
declare function escapeTextUnderscores(text: string): string;
/**
 ...
 */
declare const isLastFormulaRenderable: (text: string) => boolean;
/**
 ...
 */
declare function fixCommonLaTeXErrors(text: string): string;
/**
 ...
 */
declare function normalizeLatexSpacing(text: string): string;
/**
 ...
 */
declare function validateLatexExpressions(text: string): {
  errors: Array<{
    formula: string;
    message: string;
    position: number;
 ...
 */
declare function handleCJKWithLatex(text: string, addSpaces?: boolean): string;
interface AdvancedPreprocessOptions {
 ...
 * ```
 */
declare function preprocessLaTeX(text: string, options?: AdvancedPreprocessOptions): string;
/**
 ...
 * ```
 */
declare function preprocessLaTeXStrict(text: string): string;
/**
 ...
 * ```
 */
declare function preprocessLaTeXMinimal(text: string): string;
//#endregion
export { AdvancedPreprocessOptions, convertLatexDelimiters, escapeCurrencyDollars, escapeLatexPipes, escapeMhchemCommands, escapeTextUnderscores, fixCommonLaTeXErrors, handleCJKWithLatex, isLastFormulaRenderable, normalizeLatexSpacing, preprocessLaTeX, preprocessLaTeXMinimal, preprocessLaTeXStrict, validateLatexExpressions };