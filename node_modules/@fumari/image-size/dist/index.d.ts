...
'ETIMEDOUT';
declare class ImageSizeError extends Error {
...
interface ProbeOptions extends RequestOptions {
  /**
 ...
 */
declare function imageSize(data: Uint8Array): ImageSizeResult | null;
/**
 ...
 */
declare function probe(src: string | URL, { limit, ...request }?: ProbeOptions): Promise<ImageSizeResult>;
//#endregion
export { type ImageSize, ImageSizeError, type ImageSizeErrorCode, type ImageSizeResult, type ImageType, type Parser, ProbeOptions, type RequestOptions, imageSize, probe };